...
| Archivo | Qué es |
|---|---|
| `Resumen_Industrias_y_Procesos_Biotecnologicos.pdf` | Resumen integral de 44 páginas: clases 1 a 4, TP 1 y TP 2, diagramas, seis problemas resueltos paso a paso, formulario completo, tabla de valores típicos y 45 preguntas de examen con respuesta. |
